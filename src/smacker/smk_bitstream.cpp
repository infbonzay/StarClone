...
/* BITSTREAM Functions */
struct smk_bit_t *smk_bs_init(unsigned char *b, const unsigned int size)
{
	...
	ret = (struct smk_bit_t *) malloc(sizeof(struct smk_bit_t));
	memset(ret, 0, sizeof(struct smk_bit_t));
