...
//					nrofunits = 1;
		...
		case TRG_ACTIONTYPE_LEADERBOARDPOINTS://21
			...
			leaderboard = AddLeaderBoard(MAINLEADERBOARD, temptrg->action[i].actiontype, info, playernrmask, unitnr, nrofunits, temptrg->action[i].stringID - 1, 0);
			triggset = 1;
			break;
		...
		case TRG_ACTIONTYPE_LEADERBOARDGOALKILLS://36
			unitnr = temptrg->action[i].unitorrestype;
			nrofunits = temptrg->action[i].rescount;
			leaderboard = AddLeaderBoard(MAINLEADERBOARDGOAL, temptrg->action[i].actiontype, info, playernrmask, unitnr, nrofunits, temptrg->action[i].stringID - 1, 0);
			triggset = 1;
			break;
