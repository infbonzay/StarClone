...
char    *rezu[45]={"[NEWOBJECT]","ENDOBJ","NOADDSTATSATCONSTR",
                       "NOUSED","NOTUSED","SPEEDUPG","ULTRALISKSECONDARMOR",
                       "SIGHTUPG","NOUSED","MANAUPG",
                       "NOTUSED","PROPERTIES","TIMELEFT","NOTUSED",
                       "NOTUSED","CREATEFROMUNIT","ATACKSPEEDUPG","NOTUSED","NOUSED",
                       "NOTUSED","NOTUSED","NOTUSED",
                       "NOTUSED", "notused","NOTUSED","NOTUSED",
                       "READYDECONSTR","NOTUSED","HAVECHILD","RECHARGE",
                       "NOTUSED2","NOTUSED","NOTUSED","NOTUSED",
		       "NOTUSED3","NOTUSED","CREEP","OFFOTHEROBJ",
		       "NOTUSED","NOTUSED","CLOAKRANGE","ADDITIONALTEXT","NOTUSED",
		       "NOTUSED","NOTUSED"
                       };
char	*soundtypes[MAXTYPESOFSOUND]= 
			{"BEGINATTACK","DEATH","ERROR","WORK","WORKDONE",
			 "HIT","PSS","MAGE5","MAGE6","MAGE7","MAGE8",
			 "READY","SELECT","ACTION","MODEIN","MODEOUT",
			 "BEGINCONSTRUCT","CONSTRUCT","WARP","ONMOVE","DECONSTRUCT"
			};

char    *rezo[23]={  "LANG","GAMEPATH","MAPPATH","GAMESPEED","MUSICVOLUME","SOUNDVOLUME","UNITSPEACH",
	    	    ...
	    	    "NETWORKLATENCY","INSTALLFILES","FIRSTRUN"
	    	 };
char    *rezmp[27]={"[NEWMAGE]","MINDISTANCE","DIAPAZONE",
                  "notused","notused","DAMAGE","RIGHTWAY","notused",
                  "notused","IGNOREREQ","notused","TIMEMAGEACTIVE",
		  "notused","notused","notused","IMAGES_ID",
		  "notused","ORDERID","DEPENDONTYPEID","notused","CREATEWEAPON",
...
int 	MAPREGENERATIONBIT,MAPUNITSREGENERATIONBIT,NEEDTOCHANGEMANABIT,NEEDTOCHANGECREEPBIT,NEEDTOHEALBIT,NEEDTOINFESTBIT,NEEDTOGATHERRETBIT;
int	NEEDTOMOVE1BIT,NEEDTOMOVE2BIT,NEEDTOREPAIRREFRESHBIT,DOODADSCROLLBIT;
...
char    nickname[25];
char	GAMEPATH[512];
char	GAMEMAPPATH[512];
char    ADDGAMEPATH[512]={"BroodWar"};
char	SELECTMAP[1024];
char 	FULLFILENAME[1024];
char 	SAVELOADFILENAME[1024];
char	MPQMISSING[1024];
