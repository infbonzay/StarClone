...
const char	  *rezmp[17] = { "[NEWMAGE]","MINDISTANCE","DIAPAZONE","RIGHTWAY","IGNOREREQ","TIMEMAGEACTIVE",
				  "IMAGES_ID","USETECHID","DEPENDONTYPEID","WEAPONID","QUEUEDTOMOVELIST","CANNOTBEINTERRUPTED",
				 "SOUNDONCASTANDHIT","RACE","SHOWHALLUCINATED","ORDERTYPE","DONOTCREATEWEAPON"
};
