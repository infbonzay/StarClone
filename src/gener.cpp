...
{
    MakeQueueAction(SOMENEEDEDACTION,SPECIALMAPID,&MAPREGENERATIONBIT,MINIMAPREFRESHCYCLE,0,0,1);
    MakeQueueAction(SOMENEEDEDACTION,SPECIALMAPUNITSID,&MAPUNITSREGENERATIONBIT,MINIMAPUNITSREFRESHCYCLE,0,0,1);
    MakeQueueAction(SOMENEEDEDACTION,SPECIALLIFEID,&NEEDTOCHANGEMANABIT,CHANGEMANACYCLE,0,0,1);
    MakeQueueAction(SOMENEEDEDACTION,SPECIALCREEPID,&NEEDTOCHANGECREEPBIT,CHANGECREEPCYCLE,0,0,1);
    MakeQueueAction(SOMENEEDEDACTION,SPECIALHEALID,&NEEDTOHEALBIT,BATTERYMEDICCYCLE,0,0,1);
    MakeQueueAction(SOMENEEDEDACTION,SPECIALINFESTID,&NEEDTOINFESTBIT,QUEENINFESTCYCLE,0,0,1);
    MakeQueueAction(SOMENEEDEDACTION,SPECIALGATHERRETID,&NEEDTOGATHERRETBIT,DRONERETURNCYCLE,0,0,1);
    MakeQueueAction(SOMENEEDEDACTION,SPECIALMOVEREFRESHID,&NEEDTOMOVE1BIT,MOVEREFRESH1CYCLE,0,0,1);
    MakeQueueAction(SOMENEEDEDACTION,SPECIALMOVEREFRESHID,&NEEDTOMOVE2BIT,MOVEREFRESH2CYCLE,0,0,1);
    MakeQueueAction(SOMENEEDEDACTION,SPECIALREPAIRID,&NEEDTOREPAIRREFRESHBIT,REPAIRREFRESHCYCLE,0,0,1);
    MakeQueueAction(SOMENEEDEDACTION,SPECIALDOODADSCROLLID,&DOODADSCROLLBIT,DOODADREFRESHCYCLE,0,0,1);
}
//==========================
void clearactionBITS(void)
{
    ...
    NEEDTOCHANGEMANABIT=0;
    NEEDTOCHANGECREEPBIT=0;
    NEEDTOHEALBIT=0;
    NEEDTOINFESTBIT=0;
    NEEDTOGATHERRETBIT=0;
    NEEDTOMOVE1BIT=0;
    NEEDTOMOVE2BIT=0;
