...
static void OutputBits(TCmpStruct * pWork, unsigned int nbits, unsigned int bit_buff)
{
...
static unsigned int FindRep(TCmpStruct * pWork, unsigned char * srcbuff)
{
