...
static unsigned int Table1503F120[] =
{
...
static unsigned int Table1503F1A0[] =
{
...
int CompressWave(unsigned char * pbOutBuffer, int dwOutLength, short * pwInBuffer, int dwInLength, int nCmpType, int nChannels)
{
    ...
    int      nArray3[2];                // EBP-48
    int      nArray2[2];                // EBP-40
    int      nArray1[2];                // EBP-38
    int      nWords;                    // EBP-30
    unsigned EBP2C;                     // EBP-2C
    int      nRemains = dwOutLength;    // EBP-28 : Number of bytes remaining
    int      nCmpType2;                 // EBP-24
...
int DecompressWave(unsigned char * pbOutBuffer, int dwOutLength, unsigned char * pbInBuffer, int dwInLength, int nChannels)
{
    ...
    while(in.pb < pbInEnd)
    {
        ...
        {
            unsigned int temp1 = Table1503F1A0[nArray1[index]]; // EDI
            unsigned int temp2 = temp1 >> pbInBuffer[1];      // ESI
            int  temp3 = nArray2[index];                // ECX
