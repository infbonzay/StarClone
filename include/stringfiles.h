...
#define BUILDFULLPCX		"pbrfull.pcx"

#define STAR_INSTALL_SOMEFILE	"files\\stardat.mpq"
#define BROOD_INSTALL_SOMEFILE	"files\\broodat.mpq"

#define STAR_TRGMELEEFILE	"triggers\\melee.trg"
