...
#define VARMOVEOBJACT					0x02000000
#define UNITPROP_PREVCLOAK				0x04000000
#define VARINVINCIBILITY				0x08000000
#define VARAUTOMATICDOODAD				0x10000000
#define VARPATROLFLAG					0x20000000
#define VARNEXTMODEMOVEIGNOREINERTION	0x40000000
#define VARNEEDTOLAUNCHINTERCEPTORS		0x80000000
